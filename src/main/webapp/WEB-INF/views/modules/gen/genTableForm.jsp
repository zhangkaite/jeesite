...
<head>
    ...
    <script type="text/javascript">
        ...
        function addTr() {
            ...
            var genTableId = $("input[name='columnList[0].genTable.id']").val();
            ...
            str = str + "<td> <input type='text' name='columnList[" + i +
                    "].comments' value='${column.comments}' maxlength='200' class='required' style='width:100px;'/></td>";
            str = str + "<td nowrap> <input type='text' name='columnList[" + i + "].jdbcType' value='' class='required' style='width:100px;' /> </td>";
            str = str + "<td> <select name='columnList[" + i +
                    "].javaType' class='required input-mini' style='width:85px;*width:75px'> <c:forEach items='${config.javaTypeList}' var='dict'>";
            str = str + "<option value='${dict.value}'  title='${dict.description}'>${dict.label}</option> </c:forEach> </select> </td>";
            str = str + "<td><input type='text' name='columnList[" + i +
                    "].javaField' value='${column.javaField}' maxlength='200' class='required input-small'/></td>";
            str = str + "<td><input type='checkbox' name='columnList[" + i + "].isPk' value='1' /></td>";
            str = str + "<td><input type='checkbox' name='columnList[" + i + "].isNull' value='1' /> </td>";
            str = str + "<td> <input type='checkbox' name='columnList[" + i + "].isInsert' value='1' /> </td>";
            str = str + "<td> <input type='checkbox' name='columnList[" + i + "].isEdit' value='1' /></td>";
            str = str + "<td> <input type='checkbox' name='columnList[" + i + "].isList' value='1' /></td>";
            str = str + "<td><input type='checkbox' name='columnList[" + i + "].isQuery' value='1' /></td>";
            str = str + "<td><select name='columnList[" + i + "].queryType' class='required input-mini'> <c:forEach items='${config.queryTypeList}' var='dict'>";
            str = str + "<option value='${fns:escapeHtml(dict.value)}' title='${dict.description}'>${fns:escapeHtml(dict.label)}</option></c:forEach> </select> </td>";
            str = str + "<td> <select name='columnList[" + i + "].showType' class='required' style='width:100px;'> <c:forEach items='${config.showTypeList}' var='dict'>";
            str = str + "<option value='${dict.value}'  title='${dict.description}'>${dict.label}</option></c:forEach> </select></td>";
            str = str + "<td> <input type='text' name='columnList[" + i + "].dictType'  value='' maxlength='200' class='input-mini'/> </td>";
    ...
    <c:otherwise>
        <form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/save" method="post"
            ...
            <fieldset>
                ...
                <legend>字段列表<shiro:hasPermission name="gen:genTable:edit">
                    <input id="btnSubmit" class="btn btn-primary" onclick="addTr()"
                           type="button"
                           value="新增"/>&nbsp;</shiro:hasPermission>
                    <input id="btnCancel" class="btn" type="button" value="删除" onclick="delSelectTr()"/></legend>
